...
\fun{GEN}{FpXQV_ellcharpoly}{GEN E, GEN T, GEN p}
Let $E$ be a vector $[a_1,a_2,a_3,a_4,a_6]$ defining the plane curve
$y^2+a_1\*x\*y+a_3\*y = x^3+a_2\*x^2+a_4\*x+a_6$ over $\F_p[X]/(T)$,
returns the characteristic polynomial of the Frobenius acting on its
first $l$-adic cohomology group (which can be of degree $0$, $1$ or $2$.)

...
%
(On macOS, this is also provided in the \kbd{Xcode} tool suite;
or the lightweight ``Command-Line Tools (CLT) for \kbd{Xcode}''.) You can
...
\item on macOS: these systems comes equipped with a fake \kbd{readline},
...
target directories. (Tip for macOS beginners: use \kbd{sudo make install}.)

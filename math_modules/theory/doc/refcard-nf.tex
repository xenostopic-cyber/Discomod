...
\li{is $p$ coprime to $h(\Q(\zeta_p))$?}{primeisregular$(p)$}
...
\li{put ideal $a$ ($a\ZZ_K+b\ZZ_K$) in HNF}{idealhnf$(\var{nf},a,\{b\})$}
\li{HNF for ideal generated by $a_1, \dots, a_n$}{idealfromgens$(\var{nf},a)$}

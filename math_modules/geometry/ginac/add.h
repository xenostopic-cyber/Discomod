...
protected:
	...
	void print_add_sorted(const print_context& c, const char* openbrace, const char* closebrace, const char* mul_sym, unsigned level) const;
	void do_print(const print_context & c, unsigned level) const;
	void do_print_sortex(const print_sortex & c, unsigned level) const;

...
/** Context for lexicographically sorted (ginsh-parsable) output. */
class print_sortex : public print_dflt
{
	GINAC_DECLARE_PRINT_CONTEXT(print_sortex, print_dflt)
public:
	print_sortex(std::ostream &, unsigned options = 0);
};

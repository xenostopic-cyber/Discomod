...
static const std::string& get_default_TeX_name(const std::string& name)
{
	...
	if (!names_initialized) {
		standard_names["alpha"] = "\\alpha"s;
		standard_names["beta"] = "\\beta"s;
		standard_names["gamma"] = "\\gamma"s;
		standard_names["delta"] = "\\delta"s;
		standard_names["epsilon"] = "\\epsilon"s;
		standard_names["varepsilon"] = "\\varepsilon"s;
		standard_names["zeta"] = "\\zeta"s;
		standard_names["eta" ] = "\\eta"s;
		standard_names["theta"] = "\\theta"s;
		standard_names["vartheta"] = "\\vartheta"s;
		standard_names["iota"] = "\\iota"s;
		standard_names["kappa"] = "\\kappa"s;
		standard_names["lambda"] = "\\lambda"s;
		standard_names["mu"] = "\\mu"s;
		standard_names["nu"] = "\\nu"s;
		standard_names["xi"] = "\\xi"s;
		standard_names["omicron"] = "\\omicron"s;
		standard_names["pi"] = "\\pi"s;
		standard_names["varpi"] = "\\varpi"s;
		standard_names["rho"] = "\\rho"s;
		standard_names["varrho"] = "\\varrho"s;
		standard_names["sigma"] = "\\sigma"s;
		standard_names["varsigma"] = "\\varsigma"s;
		standard_names["tau"] = "\\tau"s;
		standard_names["upsilon"] = "\\upsilon"s;
		standard_names["phi"] = "\\phi"s;
		standard_names["varphi"] = "\\varphi"s;
		standard_names["chi"] = "\\chi"s;
		standard_names["psi"] = "\\psi"s;
		standard_names["omega"] = "\\omega"s;
		standard_names["Gamma"] = "\\Gamma"s;
		standard_names["Delta"] = "\\Delta"s;
		standard_names["Theta"] = "\\Theta"s;
		standard_names["Lambda"] = "\\Lambda"s;
		standard_names["Xi"] = "\\Xi"s;
		standard_names["Pi"] = "\\Pi"s;
		standard_names["Sigma"] = "\\Sigma"s;

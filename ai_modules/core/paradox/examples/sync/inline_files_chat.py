"""Example demonstrating chat with inline file attachments using sync Client."""
...
def chat_with_inline_file(client: Client, file_path: str, query: str) -> None:

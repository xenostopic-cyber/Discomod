...
def test_upload_document_creates_span_with_attributes(mock_tracer: mock.MagicMock, client: Client):
    ...
    client.collections.upload_document(collection_metadata.collection_id, name, data, fields)
...
@mock.patch("xai_sdk.sync.collections.tracer")
def test_update_document_creates_span_with_attributes(mock_tracer: mock.MagicMock, client: Client):
    mock_span = mock.MagicMock()
    mock_tracer.start_as_current_span.return_value.__enter__.return_value = mock_span
